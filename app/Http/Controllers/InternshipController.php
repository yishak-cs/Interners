...
class InternshipController extends Controller
{
    ...
    public function departmentIndex(): View
    {
        ...
        return view('pages.' . $this->current_route . '.internship.list', ['internships' => $internships]);
    }
    ...
    public function companyIndex(): View
    {
        ...
        return view('pages.company.internship.list', ['internships' => $internships]);
    }
    ...
    {
        return view('pages.' . $this->current_route . '.internship.add');
    }
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        if ($internship->save()) {
            ...
            return redirect()->back()->with('success', 'Internship has been stored successfully!');
        } else {
    ...
    public function edit(Internship $internship): View|RedirectResponse
    {
        ...
        if ($this->checkAuthorizations(self::MODEL_INTERNSHIP, auth()->user()->type, $internship, self::ACTION_EDIT)) {
            return view('pages.' . $this->current_route . '.internship.edit', ['internship' => $internship]);
        } else {
            return redirect()->route($this->current_route . '.home')->with('error', 'You are not Authorized for this action!');
        }
    }
    ...
    public function update(Request $request, Internship $internship): RedirectResponse
    {
        ...
        if ($this->checkAuthorizations(self::MODEL_INTERNSHIP, auth()->user()->type, $internship, self::ACTION_UPDATE)) {
            ...
            if ($flag) {
                return redirect()->route($this->current_route . '.internship.edit', $internship->id)->with('success', 'Internship has been updated successfully!');
            } else {
                return redirect()->route($this->current_route . '.internship.edit', $internship->id)->with('error', 'Something went wrong, please try again!');
            }
        } else {
            return redirect()->route($this->current_route . '.home')->with('error', 'You are not Authorized for this action!');
        }
