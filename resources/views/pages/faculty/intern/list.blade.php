...
@section('header')
    @include('layout.header', ['title' => 'Faculty | Intern | List'])
@endsection
                                ...
                                <tbody>
                                    @foreach ($interns as $intern)
                                        <tr>
                                            ...
                                            <td><a href="{{ route('faculty.internship.view', $intern->internship->id) }}">{{ $intern->internship->title }}</a></td>
                                            <td
                                                @class([
                                            ...
                                            <td>
                                                <a href="{{ route('faculty.intern.view', $intern->id) }}">
                                                    <button class="btn btn-info btn-xs btn-flat">
                                                        <i class="fas fa-eye"></i>
                                                        View
                                                    </button>
                                                </a>
                                                <a href="{{ route('faculty.intern.delete', $intern->id) }}" onclick="if(confirm('Are you sure, you want to delete {{ $intern->user->getName() }}? This action will also deletes user\'s application!') == false){event.preventDefault()}">
