...
@section('header')
    @include('layout.header', ['title' => 'Faculty | Department | Edit'])
@endsection
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-default">
                        ...
                        <form method="POST" action="{{ route('faculty.department.update', $faculty_department->id) }}">
                            @csrf
                            <div class="card-body">
                                @if (session('error'))
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="name" placeholder="Enter Department Name" type="text"
                                                ...
                                                value="{{ $faculty_department->name }}" required autocomplete="name">
                                            @error('name')
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="description" id="description" class="form-control @error('description') is-invalid @enderror">{{ $faculty_department->description }}</textarea>
                                            @error('description')
                                                <span class="text-danger" role="alert">
                                                    {{ $message }}
                                                </span>
