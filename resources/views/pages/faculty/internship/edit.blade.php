...
@section('header')
    @include('layout.header', ['title' => 'Faculty | Internship | Edit'])
@endsection
...
@section('content')
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <form method="POST" action="{{ route('faculty.internship.update', $internship->id) }}">
                        @csrf
                ...
                <div class="col-md-12">
                    <form action="{{ route('faculty.internship.updatePre', $internship->id) }}" method="POST">
                        @csrf
                        <div class="card card-default">
                            <div class="card-header">
