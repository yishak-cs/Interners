...
@section('header')
    @include('layout.header', ['title' => 'Faculty | Application | Detail'])
@endsection
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('faculty.application.list') }}">List</a></li>
                ...
                <div class="col-md-9">
                                        ...
                                        <div id="accordion">
                                            @if ($user->information->application_letter_file_path)
                                                <div class="card card-primary">
                                                    ...
                                                    <div id="applicationLetter" class="collapse"
                                            ...
                                            @if ($user->information->student_id_file_path)
                                                <div class="card card-primary">
                                                    ...
                                                    <div id="applicationStudentId" class="collapse"
                                                        data-parent="#accordion">
                                                        <div class="card-body">
                                                            <iframe
                    ...
                    @if ($user_application->status == 0)
                        <div class="col-md-12 mb-3">
                            <a onclick="if(confirm('Are you sure, you want to reject this Application?') == false){event.preventDefault()}"
                                href="{{ route('faculty.application.reject', $user_application->id) }}"
                                class="btn btn-danger">Reject Application</a>
                            <a onclick="if(confirm('Are you sure, you want to accept this Application?') == false){event.preventDefault()}"
                                href="{{ route('faculty.application.accept', $user_application->id) }}"
                                class="btn btn-success float-right">Accept Application</a>
                        </div>
                    @else
                        <div class="col-md-12 mb-3">
                            <a onclick="if(confirm('Are you sure, you want to reset this Application status?') == false){event.preventDefault()}"
                                href="{{ route('faculty.application.reset', $user_application->id) }}"
                                class="btn btn-warning float-right">Reset Application Status</a>
                        </div>
                    @endif
                </div>
                        ...
                        <div class="card-body box-profile">
                            ...
                            <ul class="list-group list-group-unbordered mb-3">
                                <li class="list-group-item">
                                    <b>Submited</b> <a
                                        class="float-right">{{ number_format($statistics[0]['applicationCount']) }}</a>
                                </li>
                                <li class="list-group-item">
                                    <b>Pending</b> <a
                                        class="float-right">{{ number_format($statistics[0]['pendingApplications']) }}</a>
                                </li>
                                <li class="list-group-item">
                                    <b>Accepted</b> <a
                                        class="float-right">{{ number_format($statistics[0]['acceptedApplications']) }}</a>
                                </li>
                                <li class="list-group-item">
                                    <b>Rejected</b> <a
                                        class="float-right">{{ number_format($statistics[0]['rejectedApplications']) }}</a>
                                </li>
                                <li class="list-group-item">
                                    <b>Remaining Quota</b> <a
                                        class="float-right">{{ number_format($internship->quota - $statistics[0]['acceptedApplications']) }}</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-body box-profile">
                            ...
                            <ul class="list-group list-group-unbordered mb-3">
                                <li class="list-group-item">
                                    <b>Rank in date</b> <a
                                        class="float-right">{{ number_format($statistics[1]['rankByDate']) }} /
                                        {{ $statistics[0]['applicationCount'] }}</a>
                                </li>
                                <li class="list-group-item">
                                    <b>Rank in CGPA</b> <a
                                        class="float-right">{{ number_format($statistics[1]['rankByCGPA']) }} /
                                        {{ $statistics[0]['applicationCount'] }}</a>
                                </li>
                                <li class="list-group-item">
