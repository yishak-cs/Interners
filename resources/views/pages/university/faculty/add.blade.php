...
@section('header')
    @include('layout.header', ['title' => 'University | Faculty | Add'])
@endsection
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-default">
                        ...
                        <form method="POST" action="{{ route('university.faculty.store') }}">
                            @csrf
                            <div class="card-body">
                                @if (session('error'))
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="head_id" id="head_id"
                                                ...
                                                @foreach ($faculty_head_list as $faculty_head)
                                                    <option value="{{ $faculty_head->id }}">{{ $faculty_head->getName() }}
                                                    </option>
                                                @endforeach
                                            </select>
                                            @error('head_id')
                                        ...
                                        <div class="form-group">
                                            <label>Faculty Name</label> <i class="text-danger font-weight-bold">*</i>
