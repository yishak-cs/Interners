    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent" data-widget="treeview" role="menu" data-accordion="false">
                <li class="nav-item">
                    <a href="{{ route('user.home') }}" class="nav-link {{ (request()->is('user/home') || request()->is('user/internship/view*')) ? 'active' : '' }}">
                ...
                <li class="nav-item {{ (request()->is('user/profile*')) ? 'menu-open' : '' }}">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ route('user.profile.settings') }}" class="nav-link {{ (request()->is('user/profile/setting')) ? 'active' : '' }}">
