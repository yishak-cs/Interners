...
@section('header')
    @include('layout.header', ['title' => 'Company | Department | Edit'])
@endsection
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('company.department.list') }}">List</a></li>
                    ...
                    <div class="card card-default">
                        <div class="card-header">
                            ...
                            <div class="card-tools mr-5">
                                <a href="{{ route('company.department.list') }}"><button type="button" class="btn btn-tool"><i
                                            class="fas fa-arrow-left"></i>
                                            Back
                                    </button></a>
                            </div>
                        </div>
                        <form method="POST" action="{{ route('company.department.update', $department->id) }}">
                            @csrf
                            <div class="card-body">
                                @if (session('error'))
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input hidden value="{{ Auth::user()->company->id }}" name="company_id" id="company_id" />
                                        </div>
                                        <div class="form-group">
