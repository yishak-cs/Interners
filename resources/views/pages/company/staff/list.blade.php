...
@section('header')
    @include('layout.header', ['title' => 'Company | Staff | List'])
@endsection
                                ...
                                <tbody>
                                    @foreach ($staffs as $staff)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('company.staff.view', $staff->id) }}">
                                                ...
                                                <a href="{{ route('company.staff.delete', $staff->id) }}" onclick="if(confirm('Are you sure, you want to delete {{ $staff->getName() }}?') == false){event.preventDefault()}">
