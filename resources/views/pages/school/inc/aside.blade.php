        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item {{ (request()->is('staff/staff*')) ? 'menu-open' : '' }}">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ route('school.staff.add') }}" class="nav-link {{ (request()->is('school/staff/add')) ? 'active' : '' }}">
                                <i class="fas fa-plus nav-icon"></i>
                                <p>Add Staff</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('school.staff.list') }}" class="nav-link {{ (request()->is('school/staff/list') || request()->is('school/staff/view*') || request()->is('school/staff/edit*')) ? 'active' : '' }}">
                                <i class="fas fa-list nav-icon"></i>
                                <p>Staffs List</p>
                            </a>
                        </li>
