...
@section('header')
    @include('layout.header', ['title' => 'School | Staff | List'])
@endsection
                                ...
                                <tbody>
                                    @foreach ($staffs as $staff)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('school.staff.view', $staff->id) }}">
                                                ...
                                                <a href="{{ route('school.staff.delete', $staff->id) }}" onclick="if(confirm('Are you sure, you want to delete {{ $staff->getName() }}?') == false){event.preventDefault()}">
