...
@section('header')
    @include('layout.header', ['title' => 'Department | Student | Detail'])
@endsection
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('udepartment.student.list') }}">List</a></li>
                        ...
                        <div class="card-body">
                            @if ($user->information)
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <dl class="row">
                                            @if ($user->userSchool->name)
                                                <dt class="col-sm-4">department: </dt>
                                                <dd class="col-sm-8">
                                                    {{ $user->userSchool->name }}
                                                </dd>
                                            @endif
