                                    ...
                                    @foreach ($internships as $internship)
                                        <tr>
                                            ...
                                            <td>@if (!$internship->isEnded() && $internship->isStarted() && $internship->status != '2')
                                                <a href="{{ route('udepartment.internship.start', $internship->id) }}">
                                                ...
                                                @endif
                                                <a href="{{ route('udepartment.internship.view', $internship->id) }}">
                                                    <button class="btn btn-info btn-xs btn-flat">
                                                        <i class="fas fa-eye"></i>
                                                        View
                                                    </button>
                                                </a>
                                                <a href="{{ route('udepartment.internship.edit', $internship->id) }}">
                                                ...
                                                <a href="{{ route('udepartment.internship.delete', $internship->id) }}" onclick="if(confirm('Are you sure, you want to End {{ $internship->title }}?') == false){event.preventDefault()}">
                                                ...
                                                @else
                                                <a href="{{ route('udepartment.internship.delete', $internship->id) }}" onclick="if(confirm('Are you sure, you want to delete {{ $internship->title }}?') == false){event.preventDefault()}">
                                                    <button class="btn btn-danger btn-xs btn-flat">
