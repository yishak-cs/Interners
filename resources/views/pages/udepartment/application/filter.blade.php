            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-outline card-primary @if($isFilterActivated) collapsed-card @endif">
                        ...
                        <div class="card-body">
                            <form action="{{ route('udepartment.application.filter') }}" method="get">
                                <div class="row">
                                    <div class="col-md-4">
                                ...
                                <tbody>
                                    @foreach ($applications as $application)
                                        <tr>
                                            ...
                                            <td><a
                                                    href="{{ route('udepartment.internship.view', $application->internship->id) }}">{{ $application->internship->title }}</a>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ route('udepartment.application.delete', $application->id) }}"
