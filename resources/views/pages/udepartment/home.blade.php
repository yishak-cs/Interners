            ...
            <div class="row">
                <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-info">
                        ...
                        <a href="{{ route('udepartment.internship.list') }}" class="small-box-footer">
                ...
                <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-success">
                        ...
                        <a href="{{ route('udepartment.application.list') }}" class="small-box-footer">
                            More info <i class="fas fa-arrow-circle-right"></i>
                        </a>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-warning">
                        ...
                        <a href="{{ route('udepartment.application.filter', ['status'=>0]) }}" class="small-box-footer">
                            More info <i class="fas fa-arrow-circle-right"></i>
                        </a>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-secondary">
                        ...
                        <a href="{{ route('udepartment.intern.list') }}" class="small-box-footer">
                            More info <i class="fas fa-arrow-circle-right"></i>
                        </a>
                    </div>
                </div>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($applications as $application)
                                        <tr>
                                            ...
                                            <td><a href="{{ route('udepartment.internship.view', $application->internship->id) }}">{{ $application->internship->title }}</a></td>
                                            <td>{{ \Carbon\Carbon::parse($application->created_at)->setTimezone('Africa/Addis_Ababa')->format('M d, Y') }}</td>
                                            <td>
                                                <a href="{{ route('udepartment.application.view', $application->id) }}">
                                                    <button class="btn btn-info btn-xs btn-flat">
                                                        <i class="fas fa-eye"></i>
                                                        View
                                                    </button>
                                                </a>
                                                <a href="{{ route('udepartment.application.delete', $application->id) }}" onclick="if(confirm('Are you sure, you want to delete this Application?') == false){event.preventDefault()}">
