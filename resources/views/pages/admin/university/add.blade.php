...
@section('header')
    @include('layout.header', ['title' => 'Admin | University | Add'])
@endsection
...
@section('content')
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <form method="POST" action="{{ route('admin.university.store') }}">
                        @csrf
                                    ...
                                    <div class="bs-stepper-header" role="tablist">
                                        ...
                                        <div class="step active" data-target="#first-step">
                                            <button type="button" class="step-trigger" role="tab"
                                                ...
                                                <span class="bs-stepper-label">Add The University Head</span>
                                            </button>
                                        </div>
                                        <div class="line"></div>
                                        <div class="step" data-target="#second-step">
                                            <button type="button" class="step-trigger" role="tab"
                                                ...
                                                <span class="bs-stepper-label">University Detail</span>
                                            </button>
                                        </div>
                                    </div>
                                    <div class="bs-stepper-content">
                                        ...
                                        <div id="first-step" class="content active dstepper-block" role="tabpanel"
                                            ...
                                            <div class="row">
                                                ...
                                                <input hidden name="staff_type" value="1">
                                                <div class="col-md-3">
                                                    <div class="form-group">
