...
@section('header')
    @include('layout.header', ['title' => 'Admin | Company | Edit'])
@endsection
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="head_id" id="head_id"
                                                ...
                                                autofocus>
                                                @if (!empty($company->head_id))
                                                    <option value="{{ $company->head_id }}">{{ $company->head->getName() }}</option>
                                                    <option value="">None for now</option>
                                                @else
                                                    <option value="">None for now</option>
                                                @endif
                                                @foreach ($company_head_list as $company_head)
                                                    @continue($company_head->id == $company->head_id)
                                                    <option value="{{ $company_head->id }}">
                                                        {{ $company_head->getName() }}
                                                    </option>
                                                @endforeach
                                            </select>
                                            @error('head_id')
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="name" placeholder="Enter Company Name" type="text"
                                                ...
                                                value="{{ $company->name }}" required autocomplete="name">
                                            @error('name')
                                                <span class="text-danger" role="alert">
                                                    {{ $message }}
                                                </span>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="description" id="description" class="form-control @error('description') is-invalid @enderror">{{ $company->description }}</textarea>
                                            @error('description')
                                                <span class="text-danger" role="alert">
                                                    {{ $message }}
                                                </span>
